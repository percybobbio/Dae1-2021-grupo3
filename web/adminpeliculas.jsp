<%-- 
    ...
    Created on : 26-feb-2021, 23:02:45
    Author     : REIV5
--%>
        ...
        <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav mr-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="peliculacineramacontroller?txtProcesoPelicula=seleccionarTodo" target="miContenedor">Películas</a>
                    </li>
                    <li class="nav-item">
                ...
                <div class="btn-group">
                    ...
                    <div class="dropdown-menu">
                        ...
                        <a class="dropdown-item" href="#">${usuario.getEstado()}</a>
                        <div class="dropdown-divider"></div>
                        <form class="dropdown-item" method="POST" action="usercineramacontroller">
